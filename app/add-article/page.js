...
const TeacherInputPage = () => {
  ...
  const [quizQuestions, setQuizQuestions] = useState([
    { type: "truefalse", text: "", correctAnswer: "true" },
    { type: "truefalse", text: "", correctAnswer: "true" },
    { type: "truefalse", text: "", correctAnswer: "true" },
    { type: "truefalse", text: "", correctAnswer: "true" },
    { type: "truefalse", text: "", correctAnswer: "true" },
    { type: "multiple", text: "", answers: ["", ""], correctAnswer: "" },
    { type: "multiple", text: "", answers: ["", ""], correctAnswer: "" },
    { type: "multiple", text: "", answers: ["", ""], correctAnswer: "" },
    { type: "multiple", text: "", answers: ["", ""], correctAnswer: "" },
    { type: "multiple", text: "", answers: ["", ""], correctAnswer: "" },
  ...
  const handleSubmit = async (e) => {
    ...
    // Add audio file if you want to support audio upload
    ...
    try {
      ...
      toast.success("記事が正常にアップロードされました！");
      router.push("/");
      // Optionally, reset the form or redirect the user
    } catch (error) {
      toast.error("記事のアップロードに失敗しました: " + error.message);
    } finally {
